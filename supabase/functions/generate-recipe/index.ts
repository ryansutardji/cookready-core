...
- All ingredient quantities must be whole numbers or multiples of 0.5 (e.g. 0.5, 1, 1.5, 2, 2.5, 3). These are absolute amounts — never use fractions or percentages of what is available in the pantry. The quantity of the ingredient in your recipe should ALWAYS be a whole number of end in .5
